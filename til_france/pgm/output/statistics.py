...
# anc, expr, education_niveau, nb_children_ind, dur_separated, duree_en_couple, agegroup_civilstate, agegroup_work
...
list2drop = [
    'wprm_init', 'age', 'idmen', 'idfoy', 'quifoy', 'pere', 'mere', 'conj', 'duree_en_couple',
    'duree_hors_couple', 'education_niveau', 'productivite', 'xpr', 'anc']
