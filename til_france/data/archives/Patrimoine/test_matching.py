...
# #TODO: J'aime bien l'idée de regarder sur les valeurs potentielles, de séléctionner la meilleure et de prendre
# quelqu'un dans cette case.
# # L'avantage c'est qu'au lieu de regarder sur tous les individus, on regarde sur les valeurs, on a potentiellement
# plusieurs gens par
